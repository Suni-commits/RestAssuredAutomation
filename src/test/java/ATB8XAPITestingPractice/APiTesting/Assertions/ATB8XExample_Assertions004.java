...
public class ATB8XExample_Assertions004 {
    ...
    void test_createTokenid() {
        tokenId = getTokenId();  // Directly initialize tokenId here
        System.out.println(tokenId);
    ...
    void test_createBookingId() {
        bookingId = getBookingId();  // Directly initialize bookingId here
        System.out.println(bookingId);
    ...
    void test_updatebookingid() {
        bookingId = getBookingId();  // Initialize bookingId if needed
        tokenId = getTokenId();  // Initialize tokenId if needed
    ...
    @Test(priority = 4,dependsOnMethods = {"test_updatebookingid"})
